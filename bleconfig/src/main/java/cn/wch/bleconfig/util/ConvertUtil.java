...
public class ConvertUtil {
    ...
    //convert byte array to hex string with ':'
    public static String toHex(byte[] arg, int length) {
        String result = new String();
        if (arg != null) {
    ...
    public static byte[] myParseHexToBytes(final String hex) {
        ...
        String tmp = hex.substring(0).replaceAll("[^[0-9][a-f][A-F]]", "");
    ...
    public static byte[] inverseByteArray(byte[] src){
        if(src==null){
            return null;
        }
