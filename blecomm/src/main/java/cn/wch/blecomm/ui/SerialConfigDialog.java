...
import cn.wch.blecomm.storage.SerialStatusBean;
...
public class SerialConfigDialog  extends DialogFragment {
    ...
    private void initSpinner(View view){
        ...
        ArrayAdapter<CharSequence> baudAdapter = ArrayAdapter
                .createFromResource(getActivity(), R.array.baud,
       ...
       // baud.setSelection(9);
        ...
        ArrayAdapter<CharSequence> dataAdapter = ArrayAdapter
                .createFromResource(getActivity(), R.array.data,
                        R.layout.my_spinner_textview);
        baudAdapter.setDropDownViewResource(R.layout.my_spinner_textview);
        ...
        ArrayAdapter<CharSequence> stopAdapter = ArrayAdapter
                .createFromResource(getActivity(), R.array.stop,
                        R.layout.my_spinner_textview);
        baudAdapter.setDropDownViewResource(R.layout.my_spinner_textview);
        ...
        ArrayAdapter<CharSequence> parityAdapter = ArrayAdapter
                .createFromResource(getActivity(), R.array.parity,
                        R.layout.my_spinner_textview);
        baudAdapter.setDropDownViewResource(R.layout.my_spinner_textview);
    ...
    private void loadParameter(SerialStatusBean bean){
        ...
        if(bean.getSerialBaudBean()!=null){
            ...
            baud.setSelection(getIndexFromStringArray(getActivity(),R.array.baud,Integer.toString(serialBaudBean.getBaud())));
            data.setSelection(getIndexFromStringArray(getActivity(),R.array.data,Integer.toString(serialBaudBean.getData())));
            stop.setSelection(getIndexFromStringArray(getActivity(),R.array.stop,Integer.toString(serialBaudBean.getStop())));
            String parityString="";
            ...
            parity.setSelection(getIndexFromStringArray(getActivity(),R.array.parity,parityString));
        }else {
