...
import cn.wch.blecomm.MainActivity;
    ...
    protected Integer doInBackground(BytesTaskBean... bytesTaskBeans) {
        ...
        if(interval==0){
            ...
            while (flag && !isCancelled()) {
                ...
                bytesTaskBean.getModbusVcRealtimeInfo().ResetModbusVcRealtimeInfo();


                ret = CH9141BluetoothManager.getInstance().write( data,data.length);
                if (ret >= 0) {
